        ...
        {currentFile && (
          <div className="flex items-center gap-2 ml-4">
            ...
            <div className="relative">
              ...
              >
                <span>简明版 v{currentSimpleVersion?.versionNumber || 1}</span>
                      ...
                      .map((version) => (
                        <button
                          ...
                          className={`w-full px-3 py-2 text-left text-xs hover:bg-slate-700 flex items-center justify-between ${
                            version.id === currentSimpleVersion?.id ? "text-blue-400" : "text-slate-300"
                          }`}
                        >
            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center gap-1 px-2 py-1 text-xs rounded-md transition-colors ${
                  engine === "drawio" && currentProfessionalVersion
                      ...
                      [...currentFile.professionalVersions]
                        ...
                        .map((version) => (
                          <button
                            ...
                            className={`w-full px-3 py-2 text-left text-xs hover:bg-slate-700 flex items-center justify-between ${
                              version.id === currentProfessionalVersion?.id ? "text-purple-400" : "text-slate-300"
                            }`}
                          >
                            <span>v{version.versionNumber} - {formatVersionTime(version.createdAt)}</span>
            ...
            >
              ...
              <span className="hidden sm:inline">生成专业版</span>
            </button>
          </div>
        )}
      </div>
